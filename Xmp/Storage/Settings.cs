...
namespace Storage.Classes
{
    public static class Settings
    {
        //--------------------------------------------------------Attributes:-----------------------------------------------------------------\\
        #region --Attributes--
        //todo: public static readonly ApplicationDataStorageHelper LOCAL_OBJECT_STORAGE_HELPER = ApplicationDataStorageHelper.GetCurrent(new JsonObjectSerializer());
        ...
        public static object GetSetting(string token)
        {
            ...
            if (File.Exists(configPath))
            {
                ...
                return dict != null && dict.ContainsKey(token) ? dict[token] : null;
            }
