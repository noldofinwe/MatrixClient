...
namespace XmppApi.Network
{
    public class ConnectionConfiguration: AbstractDataTemplate
    {
        ...
        public readonly CustomObservableCollection<X509ChainStatus> IGNORED_CERTIFICATE_ERRORS;
        ...
        public ConnectionConfiguration()
        {
            ...
            IGNORED_CERTIFICATE_ERRORS = new CustomObservableCollection<X509ChainStatus>(false);
