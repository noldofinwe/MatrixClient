...
{
    public class SensorsNodeItemsResponseMessage: AbstractNodeItemsResponseMessage
    {
        //--------------------------------------------------------Attributes:-----------------------------------------------------------------\\
        #region --Attributes--
        ...
        //--------------------------------------------------------Constructor:----------------------------------------------------------------\\
        #region --Constructors--
        public SensorsNodeItemsResponseMessage(XmlNode node) : base(node) { }
        ...
        protected override void loadContent(XmlNodeList content)
        {
            ...
            {
                if (string.Equals(itemsNode.Name, "items") && string.Equals(itemsNode.Attributes["node"]?.Value, IoTConsts.NODE_NAME_SENSORS))
                {
